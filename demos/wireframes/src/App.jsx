...
import { CameraControls, ContactShadows, PerspectiveCamera } from '@react-three/drei'
...
function Thing() {
  ...
  return (
    <>
      ...
      <group ref={ref}>{Geometry === 'gltf' ? <Model {...opts} /> : Geometry === 'shader' ? <Shader /> : <Primitive {...opts} />}</group>
    </>
  )
}
