...
import { useGLTF, useEnvironment, CubeCamera } from "@react-three/drei";
...
type GLTFResult = GLTF & {
  ...
  materials: {
    paint: THREE.MeshPhysicalMaterial & { roughnessMapIntensity: number };
...
export default function Model({ ...props }: ThreeElements["group"]) {
  ...
  const { nodes, materials } = useGLTF(porscheModel) as unknown as GLTFResult;
  const environment = useEnvironment({ files: depotHdr });

  useLayoutEffect(() => {
    materials.paint.envMap = environment;
