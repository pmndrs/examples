...
// The font lives in this example's public/ folder; BASE_URL makes the path work under the site's per-example base path.
const interFont =
  import.meta.env.BASE_URL.replace(/\/?$/, "/") + "Inter-Regular.woff";
