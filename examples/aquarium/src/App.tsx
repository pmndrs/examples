...
export default function App({ spheres }: AppProps) {
  return (
    <Canvas
      shadows
...
function Aquarium({ children, ...props }: ThreeElements["group"]) {
  const ref = useRef<THREE.Group>(null!);
  const { nodes } = useGLTF(shapesModel) as unknown as GLTFResult;
...
*/
function Turtle(props: ThreeElements["group"]) {
