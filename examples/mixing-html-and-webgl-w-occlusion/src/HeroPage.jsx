        ...
        {({ open }) => (
          <>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          <Popover.Panel static className="absolute z-10 mt-3 -ml-4 w-screen max-w-md transform px-0 px-2">
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          leaveFrom="opacity-100 translate-y-0"
                          leaveTo="opacity-0 translate-y-1">
                          <Popover.Panel static className="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-0 px-2">
                            <div className="ring-opacity-5 overflow-hidden rounded-lg shadow-lg ring-1 ring-black">
                              <div className="relative grid gap-6 gap-8 bg-white p-8 px-5 py-6">
                                {resources.map((item) => (
                                  <a key={item.name} href={item.href} className="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
            ...
            <Transition
              ...
              <Popover.Panel focus static className="absolute inset-x-0 top-0 z-10 origin-top-right transform p-2 transition">
