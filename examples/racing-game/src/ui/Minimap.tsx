...
export function Minimap({ size = 200 }): JSX.Element {
  ...
  const screenPosition = useMemo(
    () =>
      new Vector3(
        screenSize.width / -2 - size / -2 + 30,
        screenSize.height / -2 - size / -2 + 30,
        0,
      ),
    [screenSize],
  );
  ...
  useFrame(() => {
    ...
    gl.clearDepth();
    v.subVectors(
      chassisBody.current!.getWorldPosition(playerPosition),
      levelCenter,
    );
