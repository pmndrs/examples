...
import type { BoxGeometry, Group, Mesh, MeshStandardMaterial, PositionalAudio as PositionalAudioImpl } from 'three'
...
export const Chassis = forwardRef<Group, ChassisProps>(({ args = [2, 1.1, 4.7], mass = 500, children, ...props }, ref) => {
  ...
  const { nodes: n, materials: m } = useGLTF(assetUrl('models/chassis-draco.glb')) as unknown as ChassisGLTF
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      {children}
      {ready && <PositionalAudio ref={crashAudio} url={assetUrl('sounds/crash.mp3')} loop={false} distance={5} />}
    </group>
  )
})
