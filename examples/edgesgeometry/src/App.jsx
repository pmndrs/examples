...
import bracketModel from './day58_aluminium_bracket-transformed.glb?url'
...
function Model(props) {
  ...
  return (
    <mesh castShadow receiveShadow onPointerOver={() => hover(true)} onPointerOut={() => hover(false)} geometry={nodes.defaultMaterial.geometry} {...props}>
