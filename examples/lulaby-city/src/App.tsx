...
type GLTFResult = GLTF & {
  ...
  materials: { Scene_Root: THREE.MeshStandardMaterial };
};
...
function Model({ ready }: { ready?: boolean }) {
  ...
  const { nodes, materials } = useGLTF(sceneModel) as unknown as GLTFResult;
    ...
    <group ref={group} scale={0.001} position={[0, 0, -100]} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <group position={[100000, 120000, 2000]}>
          {ready && (
            <PositionalAudio autoplay loop url={zapsplatAudio} distance={3} />
          )}
        </group>
