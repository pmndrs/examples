...
type GLTFResult = GLTF & {
  nodes: { dragon: THREE.Mesh };
  materials: { "Default OBJ.001": THREE.MeshStandardMaterial };
};
...
function Scene() {
  ...
  const { nodes, materials } = useGLTF(dragonModel) as unknown as GLTFResult;
  return (
    <>
      <MovingSpot
