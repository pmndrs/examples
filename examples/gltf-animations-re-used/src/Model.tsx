...
export default function Model({ pose, ...props }: ModelProps) {
  ...
  const { nodes } = useGraph(clone) as unknown as GraphResult;
      ...
      >
        ...
        >
          <meshStandardMaterial
            map={texture}
            map-flipY={false}
            // `skinning` is no longer part of three.js's material types, but r3f
            // still assigns unrecognized props straight onto the instance.
            {...({
              skinning: true,
            } as unknown as ThreeElements["meshStandardMaterial"])}
          />
        </skinnedMesh>
      </group>
