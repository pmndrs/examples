...
type OverlayProps = {
  caption: React.RefObject<HTMLSpanElement>;
...
const Overlay = forwardRef<HTMLDivElement, OverlayProps>(
  ({ caption, scroll }, ref) => (
    <div
      ...
      onScroll={(e) => {
        scroll.current =
          ...
          ((e.target as HTMLDivElement).scrollHeight - window.innerHeight);
    ...
    >
      ...
      <div style={{ height: "200vh" }}>
        <div className="dot">
          <h1>rocket</h1>A rocket (from Italian: rocchetto, lit.
          'bobbin/spool')[nb 1][1] is a projectile that spacecraft, aircraft or
          other vehicle use to obtain thrust from a rocket engine.
        </div>
      </div>
      <div style={{ height: "200vh" }}>
        <div className="dot">
