...
function BlueShape(props: ThreeElements["mesh"]) {
  const geo = useRef<CSGGeometryRef>(null!);
  const heart = useRef<SubtractionRef>(null!);
...
function WhiteShape(props: ThreeElements["mesh"]) {
  return (
    <mesh castShadow receiveShadow {...props}>
      <Geometry>
